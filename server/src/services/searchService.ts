...
export const searchProductsByName = async (query: string): Promise<IProduct[]> => {
  try {
...
export const searchProductsByCategory = async (category: string): Promise<IProduct[]> => {
  try {
...
export const searchProductsByKeywords = async (keywords: string[]): Promise<IProduct[]> => {
  try {
